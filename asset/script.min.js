...
function compileContent() {
    var a = "moc.liamg/sugolv".split("").reverse().join("").replace("/", "@");
    var b = {
        name: "Loganathane Virassamy",
        title: "Senior Digital Architect",
        work: {
            position: ["Senior Digital Architect"],
            company: '<a href="http://kaseya.com/">Kaseya</a>',
            location: "Bangalore, India"
        },
        interests: {
            type: "Machine Learning"
        },
        contact: ['<a class="item" href="mailto:' + a + '">' + a + "</a>", '<a class="item" href="https://in.linkedin.com/in/loganathane-virassamy-07b65358">LinkedIn</a>', '<a href="https://github.com/loganathane">Github</a>']
    };
    return "<pre id='" + contentId + "'><code>" + JSON.convertToHumanReadableString(b, 2, window.innerHeight > window.innerWidth) + "</code></pre>"
};